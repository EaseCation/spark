...
public class NemisysCommandSender extends AbstractCommandSender<CommandSender> {

    public NemisysCommandSender(CommandSender delegate) {
        super(delegate);
    }
